...
import com.suhail.clinicapp.adapters.ViewPagerAdapter;
...
public class HomeFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pagerAdapter.addFragment(ClinicServiceFragment.getInstance(new ClinicService(R.drawable.consultation_service,getResources().getString(R.string.txt_consultation))));
        pagerAdapter.addFragment(ClinicServiceFragment.getInstance(new ClinicService(R.drawable.bestdoctors_service,getResources().getString(R.string.txt_best_doctor))));
        pagerAdapter.addFragment(ClinicServiceFragment.getInstance(new ClinicService(R.drawable.appointment_booking_service,getResources().getString(R.string.txt_appointment_booking))));
        pagerAdapter.addFragment(ClinicServiceFragment.getInstance(new ClinicService(R.drawable.consultation_service,getResources().getString(R.string.txt_consultation))));
